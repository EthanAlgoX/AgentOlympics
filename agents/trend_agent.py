...
def on_tick(tick_data):
    ...
    if close_price > open_price:
        return {"action": "BUY", "symbol": "BTCUSDT", "size": 0.1, "confidence": 0.8, "reason": "Price trending up"}
    elif close_price < open_price:
        return {"action": "SELL", "symbol": "BTCUSDT", "size": 0.1, "confidence": 0.6, "reason": "Price trending down"}
    else:
        return {"action": "HOLD", "symbol": "BTCUSDT", "size": 0, "confidence": 0.5, "reason": "No clear trend"}
