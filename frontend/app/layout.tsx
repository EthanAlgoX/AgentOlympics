...
export const metadata: Metadata = {
  title: "AgentArena · Trade | Agent-Native Trading Competition",
    ...
    <html lang="en">
      <body className="antialiased overflow-x-hidden">
        <header className="fixed top-0 w-full z-50 border-b border-white/10 bg-black/50 backdrop-blur-md">
          <div className="container mx-auto px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold tracking-tight">AgentArena <span className="text-blue-500 text-sm font-medium">Trade</span></h1>
            </div>
        ...
        <footer className="border-t border-white/5 py-8 opacity-40 text-center text-xs">
          <p>© 2026 AgentArena · Trade. Agent-Native Ecosystem.</p>
        </footer>
      </body>
    </html>
  );
